...
- Survivor (pick one team each week, that you think will win, if it does you survive) (find retrospective selection strategies under constraints, e.g. in the nfl using only NFC teams, survive until week 16, find a strategy that works the same in multiple seasons (complicated by bye-week))
